...
Breadcrumbs::for('orders', function (BreadcrumbTrail $trail) {
    $trail->parent('dashboard');
    $trail->push(trans('admin::app.order.title'), route('admin.orders'));
});

Breadcrumbs::for('defective-products', function (BreadcrumbTrail $trail) {
    $trail->parent('dashboard');
    $trail->push(trans('admin::app.products.title_defective'), route('admin.products.defective'));
});

//Prodotti configurabili
Breadcrumbs::for('configurable', function (BreadcrumbTrail $trail) {
    $trail->parent('dashboard');
    $trail->push(trans('admin::app.products.title_configurable'), route('admin.products.configurable.search', [
...
//Influencers
Breadcrumbs::for('influencers', function (BreadcrumbTrail $trail) {
    $trail->parent('dashboard');
    $trail->push(trans('Influencers'), route('admin.influencers'));
});

Breadcrumbs::for('configurations', function (BreadcrumbTrail $trail) {
    $trail->parent('configurable');
    $trail->push(trans('admin::app.products.title_configurations'), route('admin.products.configurable'));
});
