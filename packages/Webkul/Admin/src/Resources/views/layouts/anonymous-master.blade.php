...
<html lang="{{ config('app.locale') }}">
    ...
    <body @if (app()->getLocale() == 'ar') class="rtl" @endif>        
            ...
            <div class="center-box">
                <div class="adjacent-center">
                    <div class="brand-logo">
                        ...
                        <img width="200" src="https://amabilejewels.it/media/logo/stores/1/SCRITTAAMABILE.png" alt="{{ config('app.name') }}"/>
                    </div>
       ...
       {{--  <script type="text/javascript" src="https://gestionale.amabilejewels.it/vendor/webkul/admin/assets/js/admin.js"></script>
        <script type="text/javascript" src="https://gestionale.amabilejewels.it/vendor/webkul/ui/assets/js/ui.js"></script> --}}
