...
<html lang="{{ config('app.locale') }}">
    <head>
        ...
        <link rel="stylesheet" href="https://gestionale.amabilejewels.it/vendor/webkul/admin/assets/css/app.css">
        @yield('head')
    ...
    <body style="scroll-behavior: smooth;" @if (app()->getLocale() == 'ar') class="rtl" @endif>
     ...
     {{--  <script type="text/javascript" src="https://vendor/webkul/admin/assets/js/admin.js"></script>
        <script type="text/javascript" src="https://vendor/webkul/ui/assets/js/ui.js"></script> --}}
