...
Route::group(['middleware' => ['web', 'admin_locale']], function () {
    ...
    Route::prefix(config('app.admin_path'))->group(function () {
        ...
        Route::group(['middleware' => ['user']], function () {
            ...
            //ORDINI
            Route::group(['preifx' => 'orders', 'namespace' => 'App\Http\Controllers'], function(){
                Route::get('/orders', 'OrderController@index')->name('admin.orders');
                Route::get('/orders/{id}/details', 'OrderController@show')->name('admin.order.show');
		        Route::put('/orders/update/{id}', 'OrderController@update')->name('admin.orders.update');
                Route::get('/orders/management', 'OrderController@showAdminOrders')->name('admin.orders.management');
                Route::get('/orders/management/assign', 'OrderController@showOrdersToAssign');
                Route::post('/orders/management/assign/save', 'OrderController@assignOrders')->name('admin.orders.management.assign.save');
                Route::get('/orders/management/assigned/show/{id}', 'OrderController@showAssignedOrder');
                Route::post('/orders/management/assign/edit', 'OrderController@editAssignedOrder')->name('admin.orders.management.assign.edit');
                Route::get('/orders/management/assigned/delete/{id}', 'OrderController@cancelAssignment')->name('admin.orders.assign.delete');
                Route::get('/orders/management/assign/searchassigned', 'OrderController@searchAssignedOrder')->name('admin.orders.management.assigned.search');
                Route::get('/orders/management/assign/search', 'OrderController@searchOrderToAssign')->name('admin.orders.management.assign.search');
                Route::get('/orders/searchorders', 'OrderController@searchOrdersOperator')->name('admin.orders.operator.search');
                Route::get('/orders/count', 'OrderController@getCompletedOrdersCount')->name('admin.orders.count');
                Route::get('/orders/sort/{param}/{order}', 'OrderController@orderData')->name('admin.orders.sort');
                Route::get('/orders/management/assign/sort/{param}/{order}', 'OrderController@orderDataAssigned')->name('admin.management.orders.sort');
                Route::get('orders/influencers', 'InfluencerOrderController@index')->name('admin.influencers.orders');
                Route::get('orders/influencers/search', 'InfluencerOrderController@search')->name('admin.influencers.orders.search');
                Route::get('orders/influencers/create', 'InfluencerOrderController@create')->name('admin.influencers.orders.create');
                Route::post('orders/influencers/create', 'InfluencerOrderController@store')->name('admin.influencers.orders.store');
                Route::get('orders/influencers/{id}', 'InfluencerOrderController@edit')->name('admin.influencers.orders.edit');
                Route::put('orders/influencers/{id}', 'InfluencerOrderController@update')->name('admin.influencers.orders.update');
                Route::delete('orders/influencers/{id}', 'InfluencerOrderController@destroy')->name('admin.influencers.orders.destroy');
            });

            Route::group(['prefix' => 'influencers', 'namespace' => 'App\Http\Controllers'], function(){
                Route::get('', 'InfluencerController@index')->name('admin.influencers');
                Route::get('search', 'InfluencerController@search')->name('admin.influencers.search');
                Route::get('create', 'InfluencerController@create')->name('admin.influencers.create');
                Route::get('{id}', 'InfluencerController@edit')->name('admin.influencers.edit');
                Route::put('{id}', 'InfluencerController@update')->name('admin.influencers.update');
                Route::post('create', 'InfluencerController@store')->name('admin.influencers.store');
                Route::delete('{id}', 'InfluencerController@destroy')->name('admin.influencers.destroy');
                //Route::get('orders/', 'InfluencerController@listOrders')->name('admin.influencers.orders');
            });


            //statistiche
            Route::group(['prefix' => 'stats', 'namespace' => 'App\Http\Controllers'], function(){
                Route::get('/standings', 'StatsController@showStandings')->name('stats.standings');
                Route::post('/stats/standings/search', 'StatsController@searchOperator')->name('stats.standings.search');
            });
            ...
            Route::group([
                ...
                Route::get('list', 'ProductController@clear')->name('admin.products.list');
                ...
                Route::post('{id}', 'ProductController@destroy')->name('admin.products.delete');

                Route::put('mass-destroy', 'ProductController@massDestroy')->name('admin.products.mass_delete');

                //Prodotti difettosi
                Route::get('defective/', 'ProductController@getDefectiveProducts')->name('admin.products.defective');
                Route::get('defective/search', 'ProductController@searchDefectiveProducts')->name('admin.products.defective.search');

                //Configurazioni prodotto
                Route::get('configurations/', 'ProductController@listConfigurableProducts')->name('admin.products.configurable');
                Route::get('configurations/list', 'ProductController@clearConf')->name('admin.products.configurable.clear');
                Route::get('configurations/search', 'ProductController@searchConfigurableProducts')->name('admin.products.configurable.search');
                Route::get('configurations/{id}/list', 'ProductController@listConfigurations')->name('admin.products.configurable.list');
                Route::get('configurations/{id}/attributes', 'ProductController@listAttributes')->name('admin.products.configurable.attributes');
                Route::post('configurations/{id}/attributes/options/', 'ProductController@listOptions')->name('admin.products.configurable.attributes.options');
                Route::post('configurations/{id}/attributes/options/show', 'ProductController@showOption')->name('admin.products.configurable.attributes.options.show');
                Route::post('configurations/{id}/attributes/options/create', 'ProductController@addOptions')->name('admin.products.configurable.attributes.options.add');
                Route::get('configurations/{id}/show-products', 'ProductController@showProducts')->name('admin.products.configurable.show-products');
                Route::post('configurations/{id}/add-products/', 'ProductController@addProducts')->name('admin.products.configurable.add-products');
                Route::get('configurations/{id}/{childSku}', 'ProductController@removeConfigurableOption')->name('admin.products.configurable.remove');
                //Simple products attributes
                Route::get('{id}/attributes', 'ProductController@listAttributesProduct')->name('admin.products.attributes');
                Route::post('{id}/attributes/options/', 'ProductController@listOptionsProduct')->name('admin.products.attributes.options');
                Route::post('{id}/attributes/options/create', 'ProductController@addOptionProduct')->name('admin.products.attributes.options.add');
            });
