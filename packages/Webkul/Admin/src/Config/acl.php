...
return [
    ...
    [
        'key' => 'products-graveyard',
        'name' => 'Cimitero',
        'route' => 'admin.products.defective',
        'sort' => 12,
    ],
    [
        'key'        => 'configurations',
        'name'       => 'Configurazioni',
        'route'      => 'admin.products.configurable',
        'sort'       => 13,
    ...
    [
        'key'        => 'influencer-orders',
        'name'       => 'Ordini influencer',
        'route'      => 'admin.influencers.orders',
        'sort'       => 15,
